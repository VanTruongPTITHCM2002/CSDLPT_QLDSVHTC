...
namespace QLDSV_TC
{
    public partial class RpfScoresCreditClass : DevExpress.XtraEditors.XtraForm
    {
        ...
        public RpfScoresCreditClass()
        {
            InitializeComponent();
        }

        private void RpfScoresCreditClass_Load(object sender, EventArgs e)
        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            if (checkData())
            {
               ...
               XrptScoresCreditClass xrpt = new XrptScoresCreditClass(schoolYear, semester, subjectCode, group);
